...
#su.print_conv = True
su.print_conv = False 
su.evolve(steps=100,tau=0.001,progbar=True)
fpeps = su.state
...
print('per site energy=',sum(w[:nelec[0]])/(Lx*Ly))

energy = fpeps.compute_local_expectation(ham.terms,normalized=True,max_bond=20) 
