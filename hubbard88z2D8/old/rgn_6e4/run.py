...
#fpeps = load_ftn_from_disc(f'../tmpdir/su_{Lx},{Ly}_D{D}_200_2')
fpeps = load_ftn_from_disc(f'../sr_6e4/psi40')
scale = 1.15
...
tmpdir = './' 
#ham = Hubbard(t,u,Lx,Ly,grad_by_ad=False,tmpdir=tmpdir,log_every=40)
